...
const Experience = () => {
    return (
        <div
            className="rewards py-20 px-8 md:h-full h-full bg-[#1a61e9] bg-right bg-no-repeat bg-cover"
                    ...
                    <div className="p-4 w-full">
                        <div className="space-y-4  ">
                            ...
                            <p className="font-semibold leading-[22px]">
                                never miss a due date with reminders to help you
                                pay your bills on time, instant settlements mean
                                you never wait for your payments to go through
                                and statement analysis lets you know where your
                                money goes, always.
                            </p>
                        </div>
